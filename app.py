...
app.config['UPLOAD_FOLDERS'] = '/static/profile_pics'
...
def sign_up():
    ...
    doc = {
        ...
        "profile_name": username_receive.lower(),                   # user's name is set to their id by default
        "profile_pic": "",                                          # profile image file name
        "profile_pic_real": "profile_pics/default-profile.png", # a default profile image
...
def get_posts():
    ...
    try:
        ...
        for post in posts:
            ...
            post['thumbs_up_by_me'] = bool(db.likes.find_one({
                'post_id': post['_id'],
                'type': 'thumbs-up',
                'username': payload.get('id'),
            }))
